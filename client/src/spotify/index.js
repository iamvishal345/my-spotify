...
export const getNextPage = (url) => axios.get(url, { headers });

/**
 * Get a User's Top Artists
 * https://developer.spotify.com/documentation/web-api/reference/personalization/get-users-top-artists-and-tracks/
 */
export const getTopArtists = (duration) =>
  axios.get(
    `https://api.spotify.com/v1/me/top/artists?limit=50&time_range=${duration}_term`,
    {
      headers,
    }
  );
 ...
 * https://developer.spotify.com/documentation/web-api/reference/personalization/get-users-top-artists-and-tracks/
 */
export const getTopTracks = (duration) =>
  axios.get(
    `https://api.spotify.com/v1/me/top/tracks?limit=50&time_range=${duration}_term`,
    { headers }
  );
...
/**
 * Get an Artist's albums according to country
 * hhttps://developer.spotify.com/documentation/web-api/reference/#endpoint-get-an-artists-albums
 */
export const getArtistAlbums = (artistId) =>
  axios.get(
    `https://api.spotify.com/v1/artists/${artistId}/albums?market=IN&limit=10&offset=0`,
    {
      headers,
    }
  );
 ...
 * https://developer.spotify.com/documentation/web-api/reference/playlists/get-playlist/
 */
export const removeTrackFromPlayList = (playlistId, tracks) =>
